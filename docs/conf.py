...
htmlhelp_basename = 'TAKProjectDoc'
...
latex_documents = [
    (master_doc, 'TAKProject.tex', 'TAK Projects Documentation',
     'Toure A. Karim', 'manual'),
]
...
html_context['github_user'] = 'trabdlkarim'
html_context['github_repo'] = 'trabdlkarim.github.io'
html_context['github_version'] = 'stable/docs/'
